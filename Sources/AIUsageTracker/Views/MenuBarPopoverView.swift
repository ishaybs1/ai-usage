...
struct MenuBarPopoverView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            // How to read the two numbers: Claude is priced from local tokens at list rates
            // (an estimate — real Enterprise billing includes allowances/discounts); Cursor is the
            // actual charged amount from Cursor's own billing.
            Text("Claude = est. (list price) · Cursor = actual billed")
                .font(.caption2)
